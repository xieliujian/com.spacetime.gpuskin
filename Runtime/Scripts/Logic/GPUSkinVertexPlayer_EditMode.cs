...
namespace ST.GPUSkin
{
    ...
    public partial class GPUSkinVertexPlayer
    {
        ...
        void InitMaterial(MeshRenderer renderer)
        {
            ...
            mat.SetFloat(GPUSkinDefine.GPUSKIN_SHADER_VERTEX_ANIM_TEX_WIDTH_ID, infoDB.texWidth);
            mat.SetFloat(GPUSkinDefine.GPUSKIN_SHADER_VERTEX_ANIM_TEX_HEIGHT_ID, infoDB.texHeight);
            mat.SetFloat(GPUSkinDefine.GPUSKIN_SHADER_VERTEX_COUNT_ID, infoDB.vertexCount);
        }
#endif
    }
}
