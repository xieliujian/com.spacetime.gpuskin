...
namespace ST.GPUSkin
{
    ...
    public partial class GPUSkinVertexPlayer
    {
        ...
        void InitMaterial(MeshRenderer renderer)
        {
            ...
            mat.SetTexture(GPUSkinDefine.GPUSKIN_SHADER_VERTEX_ANIM_TEX_ID, m_InfoDB.texture);
            mat.SetFloat(GPUSkinDefine.GPUSKIN_SHADER_VERTEX_ANIM_TEX_WIDTH_ID, m_InfoDB.texWidth);
            mat.SetFloat(GPUSkinDefine.GPUSKIN_SHADER_VERTEX_ANIM_TEX_HEIGHT_ID, m_InfoDB.texHeight);
            mat.SetFloat(GPUSkinDefine.GPUSKIN_SHADER_VERTEX_COUNT_ID, m_InfoDB.vertexCount);
        }
#endif
    }
}
